...
-- 2. YOL
SELECT * FROM personel WHERE id >='1003' and <='1005';

-- Derya Soylu ile Yavuz Bal arasındaki personel bilgisini listele
...
--IN ;Birden fazka mantıksal ifade ile tanımlayabileceğimiz durumları tek komutta yazabilme imkanı verir
--Farkli sutunlar için IN kullanılmaz
...
--ismi t hardi ile biten personeli listele
